 ...
 */
class AllowanceTouchIssueService extends InvoiceService
{
    ...
    public function runValidate($method)
    {
        switch ($method) {
            case 'store':
                $rules = [
                    'allowance_status' => 'required|integer|in:1,2',
                    'allowance_no' => 'required|string|max:20',
                ];
    ...
    public function store()
    {
        ...
        $result = (new InvoiceService())->invoiceMake($req_result, 'allowance_touch_issue');
