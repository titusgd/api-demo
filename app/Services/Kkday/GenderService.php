...
// models
use App\Models\Kkday\Gender;
// methods
use App\Services\Kkday\KkdayService;
use Illuminate\Http\Request;
use App\Traits\RulesTrait;

class GenderService extends KkdayService
{
    use RulesTrait;
    ...
    public function store()
    {
        ...
        Gender::create($this->request->toArray());
    ...
    {
        if (!empty($this->response)) return $this;
        Gender::where('id', '=', $this->dataId)->delete();
        $this->response = KkdayService::response('00', 'ok');
        return $this;
    }
    ...
    {
        $data = KkdayService::loadJsonData(base_path() . '/app/Services/Kkday/Gender.json');
