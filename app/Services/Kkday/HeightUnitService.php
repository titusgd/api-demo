...
// models
use App\Models\Kkday\HeightUnits;
// methods
use App\Services\Kkday\KkdayService;
use Illuminate\Http\Request;
use App\Traits\RulesTrait;

class HeightUnitService extends KkdayService
{
    use RulesTrait;
    ...
    public function store()
    {
        ...
        HeightUnits::create($this->request->toArray());
    ...
    {
        if (!empty($this->response)) return $this;
        HeightUnits::where('id', '=', $this->dataId)
    ...
    {
        if (!empty($this->response)) return $this;
        HeightUnits::where('id', '=', $this->dataId)->delete();
        $this->response = KkdayService::response('00', 'ok');
        return $this;
    }
    ...
    {
        $data = KkdayService::loadJsonData(base_path() . '/app/Services/Kkday/HeightUnit.json');
