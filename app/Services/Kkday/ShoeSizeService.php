...
// models
use App\Models\Kkday\ShoeSize;
// methods
use App\Services\Kkday\KkdayService;
use Illuminate\Http\Request;
use App\Traits\RulesTrait;

class ShoeSizeService extends KkdayService
{
    use RulesTrait;
    ...
    public function store()
    {
        ...
        ShoeSize::create($this->request->toArray());
    ...
    {
        if (!empty($this->response)) return $this;
        ShoeSize::where('id', '=', $this->dataId)->delete();
        $this->response = KkdayService::response('00', 'ok');
        return $this;
    }
    ...
    {
        $data = KkdayService::loadJsonData(base_path() . '/app/Services/Kkday/ShoeSize.json');
