...
// models
use App\Models\Kkday\AppClass;
// methods
use App\Services\Kkday\KkdayService;
use Illuminate\Http\Request;
use App\Traits\RulesTrait;

class AppClassService extends KkdayService
{
    use RulesTrait;
    ...
    public function store()
    {
        ...
        AppClass::create($this->request->toArray());
    ...
    {
        if (!empty($this->response)) return $this;
        AppClass::where('id', '=', $this->dataId)->delete();
        $this->response = KkdayService::response('00', 'ok');
        return $this;
    }
    ...
    {
        $data = KkdayService::loadJsonData(base_path() . '/app/Services/Kkday/AppClass.json');
