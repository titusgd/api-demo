...
class TestController extends Controller
{
    ...
    public function KkdayProductSearch(Request $request, $page = 1, $page_size = 1000)
    {
        ...
        Log::info('=== KkdayProductSearch start ===');
        ...
        for ($vl = 1; $vl <= $page_count; $vl++) {
            ...
            Log::info('=== KkdayProductSearch page ===' . $vl);
            foreach ($data as $k => $v) {
                ...
                if (!$base) {
                    ...
                    Log::info('=== KkdayProductSearch prod_no ===' . $prod_no);
        ...
        Log::info('=== KkdayProductSearch end ===');
    }
}
